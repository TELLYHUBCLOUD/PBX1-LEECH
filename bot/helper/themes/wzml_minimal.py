...
class WZMLStyle:
    ...
    ST_BN2_NAME = '🛠️ Updates'
    ST_BN2_URL = 'https://t.me/TELLYMIRROR'
    ST_MSG = '''✨ <i>This bot can mirror all your linksfilestorrents to Google Drive or any rclone cloud or to telegram or to ddl servers.</i>
<b>Type {help_command} to get a list of available commands</b>'''
    ST_BOTPM = '''🕵️<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''⚠️ <i>You Are not authorized user! Deploy your own WZML-X Mirror-Leech bot</i>'''
...
<a href="https://t.me/TELLYMIRROR"><b>♥️ ρσωєя ву @тєℓℓумιяяσя�</b></a>
